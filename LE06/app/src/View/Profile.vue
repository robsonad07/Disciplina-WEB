<script setup>
  ...
  import imagem1 from '../assets/eu.jpg';
...
<template>
  <div class="container-fluid row">
    <div class="col-sm-1 col-md-1 col-lg-3" id="menu-navegacao">
    <img src="../assets/tiziu.png"  alt="tziu bird image" />
    <ul id="menu-navegacao-lista">
      <router-link to="/">
        <ItemMenu
